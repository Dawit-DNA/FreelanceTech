        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    .FirstOrDefaultAsync(m => m.NormalizedEmail == this.Input.Email.ToUpper());
                    RegisterModel.registeredUser = user.Id;
                    ...
                    switch (role.NormalizedName){
                        ...
                        case "BUSINESSANALYST":
                            {
                                returnUrl = returnUrl ?? Url.Content("~/BusinessAnalysts/Index");
                                break;
                            }
                        default:
                            {
